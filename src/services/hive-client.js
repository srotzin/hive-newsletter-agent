...
const DID='did:hive:hiveforce-newsletter';const ID={name:'HiveForce-Newsletter',purpose:'Automated newsletter — ecosystem updates, agent spotlights, metric digests, broadcast distribution',capabilities:["newsletter_generation","subscriber_management","digest_creation","broadcast"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-newsletter-agent',purpose:ID.purpose})}
